//
// File generated by rootcint at Tue May 21 12:05:26 2019
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::TFileString*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("TFileString", ::TFileString::Class_Version(), "./TFileString.h", 31,
...
{
      {
         const string& obj = ((TFileString*) G__getstructoffset())->at((int) G__int(libp->para[0]));
         result7->ref = (long) (&obj);
         result7->obj.i = (long) (&obj);
      }
   return(1 || funcname || hash || result7 || libp) ;
...
static int G__TFileStringDict_184_0_9(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      {
         const string* pobj;
         const string xobj = ((const TFileString*) G__getstructoffset())->at((int) G__int(libp->para[0]));
         pobj = new string(xobj);
         result7->obj.i = (long) ((void*) pobj);
         result7->ref = result7->obj.i;
         G__store_tempobject(*result7);
...
static int G__TFileStringDict_184_0_15(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 115, (long) TFileString::Class_Version());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__TFileStringDict_184_0_16(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__TFileStringDict_184_0_26(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   char* gvp = (char*) G__getgvp();
...
static int G__TFileStringDict_184_0_27(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
"u 'string' - 11 - name u 'string' - 11 - tag", (char*)NULL, (void*) NULL, 0);
   ...
   G__memfunc_setup("at",213,G__TFileStringDict_184_0_8, 117, G__get_linked_tagnum(&G__TFileStringDictLN_string), -1, 1, 1, 1, 1, 0, "i - - 0 - i", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("at",213,G__TFileStringDict_184_0_9, 117, G__get_linked_tagnum(&G__TFileStringDictLN_string), -1, 0, 1, 1, 1, 8, "i - - 0 - i", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("size",443,G__TFileStringDict_184_0_10, 107, -1, G__defined_typename("size_t"), 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("push_back",944,G__TFileStringDict_184_0_11, 121, -1, -1, 0, 1, 1, 1, 0, "u 'string' - 11 - s", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("add",297,G__TFileStringDict_184_0_12, 121, -1, -1, 0, 1, 1, 1, 0, "u 'string' - 11 - s", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Class",502,G__TFileStringDict_184_0_13, 85, G__get_linked_tagnum(&G__TFileStringDictLN_TClass), -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (TClass* (*)())(&TFileString::Class) ), 0);
   G__memfunc_setup("Class_Name",982,G__TFileStringDict_184_0_14, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&TFileString::Class_Name) ), 0);
   G__memfunc_setup("Class_Version",1339,G__TFileStringDict_184_0_15, 115, -1, G__defined_typename("Version_t"), 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (Version_t (*)())(&TFileString::Class_Version) ), 0);
   G__memfunc_setup("Dictionary",1046,G__TFileStringDict_184_0_16, 121, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (void (*)())(&TFileString::Dictionary) ), 0);
   ...
   G__memfunc_setup("StreamerNVirtual",1656,G__TFileStringDict_184_0_20, 121, -1, -1, 0, 1, 1, 1, 0, "u 'TBuffer' - 1 - ClassDef_StreamerNVirtual_b", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("DeclFileName",1145,G__TFileStringDict_184_0_21, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&TFileString::DeclFileName) ), 0);
   G__memfunc_setup("ImplFileLine",1178,G__TFileStringDict_184_0_22, 105, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (int (*)())(&TFileString::ImplFileLine) ), 0);
   G__memfunc_setup("ImplFileName",1171,G__TFileStringDict_184_0_23, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&TFileString::ImplFileName) ), 0);
   G__memfunc_setup("DeclFileLine",1152,G__TFileStringDict_184_0_24, 105, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (int (*)())(&TFileString::DeclFileLine) ), 0);
   // automatic copy constructor
   G__memfunc_setup("TFileString", 1099, G__TFileStringDict_184_0_25, (int) ('i'), G__get_linked_tagnum(&G__TFileStringDictLN_TFileString), -1, 0, 1, 1, 1, 0, "u 'TFileString' - 11 - -", (char*) NULL, (void*) NULL, 0);
   // automatic destructor
   G__memfunc_setup("~TFileString", 1225, G__TFileStringDict_184_0_26, (int) ('y'), -1, -1, 0, 0, 1, 1, 0, "", (char*) NULL, (void*) NULL, 0);
   // automatic assignment operator
   G__memfunc_setup("operator=", 937, G__TFileStringDict_184_0_27, (int) ('u'), G__get_linked_tagnum(&G__TFileStringDictLN_TFileString), -1, 1, 1, 1, 1, 0, "u 'TFileString' - 11 - -", (char*) NULL, (void*) NULL, 0);
