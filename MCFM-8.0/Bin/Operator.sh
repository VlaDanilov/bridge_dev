...
cp W_only_* ${SAVEDIR}/Process_ProcNum/DynamicScale_Scales/Order/seed_numberoftheseed
...
mv Proc_ProcNum_Order_Scales_scale.o* ${SAVEDIR}/Process_ProcNum/DynamicScale_Scales/Order/seed_numberoftheseed	
cd ${SAVEDIR}/Process_ProcNum/DynamicScale_Scales/Order/seed_numberoftheseed
standSimple *.root 
echo "+++++++++++++"
ls
echo "-------------"
