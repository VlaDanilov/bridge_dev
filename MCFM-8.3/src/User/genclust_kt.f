...
c        write(*,*) 'Clustered ',nmin1,nmin2
        ...
        jetcontent(nmin1) = jetcontent(nmin1) + jetcontent(nmin2)
...
c        write(*,*) 'aeta: ',aetarap(i,qjet),' vs max. ',etajetmax
     ...
     &      (ayi >= etajetmin) .and. (ayi <= etajetmax)) then 
          ...
          jetcontent(jetindex(ajet)) = jetcontent_tmp(i)
        endif
      enddo
